...
public class SubstitutionView extends JPanel implements CardView{
    JPanel rightPane ;
    JPanel leftPane;
    JLabel chooseKeyL;
    JButton createKey;
    ...
    public SubstitutionView(String s) {
    }

    public SubstitutionView(Map<String, Object> stringObjectMap) {
    }
